...
name: bash
description: >-
  Bash and POSIX shell scripting judgment for reusable scripts, automation, CLI wrappers, dotfiles, and CI: interpreter
  boundaries, status propagation, quoting, globs, temporary resources, portability, style, and validation. Use only when
